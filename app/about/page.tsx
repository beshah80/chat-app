...
export default function About() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-10 bg-gradient-to-br from-blue-300 via-purple-300 to-pink-300 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
      <div className="max-w-5xl w-full bg-white dark:bg-gray-900 rounded-3xl p-14 shadow-2xl space-y-16">
          ...
          {team.map((member) => (
            ...
            >
              <div className="flex items-center space-x-4">
                <div className="w-16 h-16 rounded-full bg-blue-200 dark:bg-blue-800 flex items-center justify-center text-2xl font-comic text-gray-900 dark:text-white">
                  {member.name.charAt(0)}
                </div>
                <div>
                  <h2 className="text-3xl font-bold text-gray-900 dark:text-white font-comic">
                    {member.name}
                  </h2>
                  <h3 className="text-xl font-medium text-gray-700 dark:text-gray-300 font-comic">
                    {member.role}
                  </h3>
                </div>
              </div>
              <p className="mt-4 text-lg text-gray-600 dark:text-gray-400 font-comic leading-relaxed">
                {member.description}
              </p>
              <div className="mt-4 flex space-x-4">
                <a
                  ...
                  className="flex items-center px-4 py-2 bg-blue-700 text-white font-comic text-sm rounded-full hover:bg-blue-800 transition-colors duration-300 focus:outline-none focus:ring-4 focus:ring-blue-400 dark:focus:ring-blue-600"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center px-4 py-2 bg-blue-500 text-white font-comic text-sm rounded-full hover:bg-blue-600 transition-colors duration-300 focus:outline-none focus:ring-4 focus:ring-blue-400 dark:focus:ring-blue-600"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center px-4 py-2 bg-gray-800 dark:bg-gray-700 text-white font-comic text-sm rounded-full hover:bg-gray-900 dark:hover:bg-gray-600 transition-colors duration-300 focus:outline-none focus:ring-4 focus:ring-gray-400 dark:focus:ring-gray-600"
        ...
        <button
          onClick={() => navigate("/")}
          className="w-full bg-gradient-to-r from-purple-700 to-purple-600 hover:from-purple-800 hover:to-purple-700 text-white font-comic font-bold text-2xl py-5 rounded-2xl shadow-xl transition-colors duration-300 focus:outline-none focus:ring-4 focus:ring-purple-400 dark:focus:ring-purple-600"
